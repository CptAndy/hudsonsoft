...
var (
	...
	ErrDuplicateSalesNum   = errors.New("sales_num duplicate not allowed...violates unique contraints")
	ErrDuplicateTypeID     = errors.New("type_id duplicate not allowed...violates unique contraints")
